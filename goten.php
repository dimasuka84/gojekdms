...
echo color("red","| github: dimasuka84 |\n");
echo color("red","| Creator : dimasfx          |\n");
...
// function change(){
        ...
        sleep(3);
        $boba10 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"G-G3S8BKX"}');
